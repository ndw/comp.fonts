...
link:[ftp://mac.archive.umich.edu/mac/system.extensions/font/type3]
...
link:[ftp://mac.archive.umich.edu/mac/system.extensions/font/truetype]
...
[link:[Unicode sample glyph for long s (U+017F)]]. [link:[Unicode sample
glyph for integral (U+222B)]].
